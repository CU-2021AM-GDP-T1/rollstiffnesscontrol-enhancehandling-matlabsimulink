...
static const char *CompileLibs[] = {
    ...
    "libcar4sl.a	CarMaker-Car win64 10.2.1 2021-12-14",
    "libcarmaker4sl.a	CarMaker win64 10.2.1 2021-12-14",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=100201",
...
tAppStartInfo   AppStartInfo = {
    ...
    "1267",          /* App_BuildVersion    */
    "fh",     /* App_CompileUser     */
    "obelix.ipg",         /* App_CompileSystem   */
    "2021-12-14 11:20:55",  /* App_CompileTime */
