...
## Generated on : Fri Apr 01 18:08:53 2022
...
START_DIR                 = C:/rollstiffnesscontrol-enhancehandling-matlabsimulink/CM_GDP_CU/src_cm4sl
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
DEFINES_STANDARD = -DMODEL=untitled -DNUMST=4 -DNCSTATES=3 -DHAVESTDIO
...
rtGetInf.obj : $(START_DIR)/slprj/raccel/untitled/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
rt_zcfcn.obj : $(START_DIR)/slprj/raccel/untitled/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
