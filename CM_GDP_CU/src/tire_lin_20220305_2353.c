...
*   mex '-IC:/IPG/carmaker/win64-9.0.1/include' '-DLINUX' tire_lin.c
*   mex '-IC:/IPG/carmaker/win64-9.0.1/include' '-DWIN32' tire_lin.c
* Compile in 64-bit Matlab with one of
*   mex '-IC:/IPG/carmaker/win64-9.0.1/include' '-DLINUX' '-DLINUX64' tire_lin.c
*   mex '-IC:/IPG/carmaker/win64-9.0.1/include' '-DWIN32' '-DWIN64'   tire_lin.c
*/
